...
public class DensityUtils {
	...
	public static boolean judgeShopActivity(String resFile,String cacheFile){
		String temp = Constants.mSdRootPath +Constants.FOLDER_NAME + Constants.PICTURE_YUAN;
		String result = cacheFile.substring(temp.length() + 1,cacheFile.length()).trim();
		String resFileTemp = divisionFileName(resFile).trim();
		if(result.equals(resFileTemp)){
			return true;
		}
		return false;
	}
